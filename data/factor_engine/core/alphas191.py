...
class Alphas191(Alphas):
    ...
    #     return Log((Count(self.close/Delay(self.close,1) < (self.close/Delay(self.close,19))**(1/20.0)-1, 20)-1) * Sumif((self.close/Delay(self.close,1)-(self.close/Delay(self.close,19))**(1/20.0)-1)**2, 20, self.close/Delay(self.close,1) < (self.close/Delay(self.close,19))**(1/20.0)-1) / (Count(self.close/Delay(self.close,1) > (self.close/Delay(self.close,19))**(1/20.0)-1, 20) * Sumif((self.close/Delay(self.close,1)-(self.close/Delay(self.close,19))**(1/20.0)-1)**2, 20, self.close/Delay(self.close,1) > (self.close/Delay(self.close,19))**(1/20.0)-1)))
...
if __name__ == '__main__':
    ...
    year = '2022'
    list_assets = adapter.get_hs300_stocks("20220115")
